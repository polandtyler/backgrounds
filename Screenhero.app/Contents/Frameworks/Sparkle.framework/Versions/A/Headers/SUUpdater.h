...
// Sent after a update is downloaded and ready for relaunch!
- (void)updaterNeedsRelaunch:(SUUpdater *)updater;

// Return YES to relaunch after install on quit
- (BOOL)updaterShouldRelaunchAfterInstall:(SUUpdater *)updater;
